...
const TOPICS = ['Networking', 'Cybersecurity', 'Web Development', 'Operating Systems', 'AI & Algorithms', 'Database Systems', 'Cloud & DevOps', 'Mobile App Dev'];
...
export default function OnboardingPage() {
  ...
  const [selectedTopics, setSelectedTopics] = useState<string[]>(['Networking', 'Cybersecurity', 'Web Development']);
  ...
  const handleFinish = () => {
    ...
    setTimeout(() => {
      setAiStatusMessage('Identifying technical skill gaps across 8 subject multiverse tracks...');
    }, 900);
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] py-12 px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center">
        ...
        <div className="flex items-center justify-between mb-8 pb-4 border-b border-warm-200">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-warm-700 uppercase tracking-wider">
              Step {step} of 5 • Student Onboarding Survey
            </span>
          </div>
