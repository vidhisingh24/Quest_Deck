...
Quest Deck is a gamified learning platform built with Next.js, designed to make learning engaging and fun. It features interactive quests, flashcards, leaderboards, a shop, and a progression system with certificates.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/vidhisingh24/Quest_Deck.git
   ```
